...
# =============================================================================
# 1 = easiest movement
# 45 = highest resistance
#
# Buildings and ocean dont have resistance values
# They are converted to nodata/excluded cells, because they are impermeable in our context
...
def qc_plot(arr: np.ndarray, out_path: Path) -> None:
    ...
    plt.imshow(arr, cmap="viridis", vmin=1, vmax=45)
